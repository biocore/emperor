...
$(document).ready(function() {
  ...
  /**
   *
   * Test that the animation object can be constructed without any problems and
  ...
  test("Test constructor", function() {
    ...
    equal(director.mappingFileHeaders, mappingFileHeaders, 'The mapping file '+
          'headers are set correctly');
    equal(director.mappingFileData, mappingFileData, 'The mapping file data '+
          'is set correctly');
    equal(director.coordinatesData, coordinatesData, 'The coordinates data is'+
          ' set correctly');
    equal(director.gradientCategory, 'DOB', 'The gradientCategory is set'+
          ' correctly');
    equal(director.trajectoryCategory, 'Treatment', 'The trajectoryCategory '+
          'is set correctly');
  ...
  /**
   *
   * Test that the animation object cannot be constructed when there are missing
   * arguments.
   *
   */
  test("Test constructor exceptions", function() {
    ...
    throws(
      function (){
        result = new AnimationDirector(mappingFileData, coordinatesData, 'DOB',
                                       'Treatment', 1000);
      },
      Error,
    ...
    throws(
      function (){
        result = new AnimationDirector(mappingFileHeaders, coordinatesData,
                                       'DOB', 'Treatment', 1000);
      },
      Error,
    ...
    throws(
      function (){
        result = new AnimationDirector(mappingFileHeaders, mappingFileData,
                                       coordinatesData, 'Treatment', 1000);
      },
      Error,
