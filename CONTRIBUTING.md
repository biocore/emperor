...
6. Run ``python tests/all_tests.py`` to confirm that the tests pass before you make any changes.
...
9. Run ``python tests/all_tests.py`` to ensure that your changes did not cause anything expected to break.
