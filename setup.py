...
setup(name='emperor',
        ...
        package_data={'emperor':['support_files/lib.psp',
            'support_files/js/*.js', 'support_files/js/js/*.js',
            'support_files/js/js/ctm/*.js',
            ...
            'support_files/emperor/css/*.css','support_files/emperor/js/*.js',
            'support_files/emperor/lib.psp',
            'support_file/emperor/support_files/*.txt']},
        data_files={},
