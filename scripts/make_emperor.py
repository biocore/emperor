...
script_info['script_usage'] = [("Plot PCoA data","Visualize the a PCoA file "
    ...
    ("BiPlots","Create a distance biplot to visualize where samples and taxa"
    "are in PCoA space.  The cosine of the angle between taxanomic vectors"
    "approximates the correlation those two taxa.  The length of each of the"
    "taxonomic vectors approximates the variance of each taxa throughout all"
    "of the samples.  The direction of the taxanomic vector explains the "
