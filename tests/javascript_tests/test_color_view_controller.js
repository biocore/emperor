requirejs([
  ...
  $(document).ready(function() {
    ...
    test('Test _nonNumericPlottables', function() {
      ...
      var colors = {'14.7': '#f7fbff', '14.2': '#f3f8fd', 'StringValue': '#e8f2fd'};
    ...
    test('Test discrete colors are retrieved correctly', function() {
      deepEqual(ColorViewController.getDiscreteColors([0, 1, 2]), {0: '#ff0000', 1: '#0000ff', 2: '#f27304'});
    });
    ...
    test('Test discrete colors are retrieved on roll-over', function() {
      ...
      var exp = {'0': '#fbb4ae', '1': '#b3cde3', '2': '#ccebc5', '3': '#decbe4', '4': '#fed9a6', '5': '#ffffcc', '6': '#e5d8bd', '7': '#fddaec', '8': '#f2f2f2', '9': '#fbb4ae', '10': '#b3cde3', '11': '#ccebc5', '12': '#decbe4', '13': '#fed9a6', '14': '#ffffcc'};
      deepEqual(obs, exp);
    });

    test('Test discrete colors with other maps', function() {
      deepEqual(ColorViewController.getDiscreteColors([0], 'Set1'), {0: '#e41a1c'});
    });
    ...
    test('Test getScaledColors', function() {
      ...
      deepEqual(color, [{0: '#440154', 1: '#3f4a8a', 2: '#26838f', 3: '#6cce5a', 4: '#fee825'},
        '<defs><linearGradient id="Gradient" x1="0" x2="0" y1="1" y2="0"><stop offset="0%" stop-color="#440154"/><stop offset="1%" stop-color="#440456"/><stop offset="2%" stop-color="#440759"/><stop offset="3%" stop-color="#440a5c"/><stop offset="4%" stop-color="#450d5f"/><stop offset="5%" stop-color="#451062"/><stop offset="6%" stop-color="#451364"/><stop offset="7%" stop-color="#461667"/><stop offset="8%" stop-color="#46196a"/><stop offset="9%" stop-color="#461c6d"/><stop offset="10%" stop-color="#471f70"/><stop offset="11%" stop-color="#472272"/><stop offset="12%" stop-color="#472575"/><stop offset="13%" stop-color="#472877"/><stop offset="14%" stop-color="#462b79"/><stop offset="15%" stop-color="#462e7a"/><stop offset="16%" stop-color="#45307c"/><stop offset="17%" stop-color="#44337d"/><stop offset="18%" stop-color="#44367f"/><stop offset="19%" stop-color="#433980"/><stop offset="20%" stop-color="#423c82"/><stop offset="21%" stop-color="#413e83"/><stop offset="22%" stop-color="#414185"/><stop offset="23%" stop-color="#404486"/><stop offset="24%" stop-color="#3f4788"/><stop offset="25%" stop-color="#3f4a8a"/><stop offset="26%" stop-color="#3d4c8a"/><stop offset="27%" stop-color="#3c4e8a"/><stop offset="28%" stop-color="#3b508a"/><stop offset="29%" stop-color="#3a538b"/><stop offset="30%" stop-color="#39558b"/><stop offset="31%" stop-color="#38578b"/><stop offset="32%" stop-color="#375a8c"/><stop offset="33%" stop-color="#365c8c"/><stop offset="34%" stop-color="#345e8c"/><stop offset="35%" stop-color="#33618d"/><stop offset="36%" stop-color="#32638d"/><stop offset="37%" stop-color="#31658d"/><stop offset="38%" stop-color="#30688e"/><stop offset="39%" stop-color="#2f6a8e"/><stop offset="40%" stop-color="#2e6c8e"/><stop offset="41%" stop-color="#2d6e8e"/><stop offset="42%" stop-color="#2d718e"/><stop offset="43%" stop-color="#2c738e"/><stop offset="44%" stop-color="#2b758e"/><stop offset="45%" stop-color="#2a778e"/><stop offset="46%" stop-color="#297a8e"/><stop offset="47%" stop-color="#287c8e"/><stop offset="48%" stop-color="#277e8e"/><stop offset="49%" stop-color="#26808e"/><stop offset="50%" stop-color="#26838f"/><stop offset="51%" stop-color="#25858e"/><stop offset="52%" stop-color="#24878e"/><stop offset="53%" stop-color="#24898d"/><stop offset="54%" stop-color="#238b8d"/><stop offset="55%" stop-color="#238d8d"/><stop offset="56%" stop-color="#228f8c"/><stop offset="57%" stop-color="#22918c"/><stop offset="58%" stop-color="#21938b"/><stop offset="59%" stop-color="#20958b"/><stop offset="60%" stop-color="#20978b"/><stop offset="61%" stop-color="#1f998a"/><stop offset="62%" stop-color="#1f9b8a"/><stop offset="63%" stop-color="#229e88"/><stop offset="64%" stop-color="#28a284"/><stop offset="65%" stop-color="#2ea680"/><stop offset="66%" stop-color="#34aa7c"/><stop offset="67%" stop-color="#3aae78"/><stop offset="68%" stop-color="#40b274"/><stop offset="69%" stop-color="#47b671"/><stop offset="70%" stop-color="#4dba6d"/><stop offset="71%" stop-color="#53be69"/><stop offset="72%" stop-color="#59c265"/><stop offset="73%" stop-color="#5fc661"/><stop offset="74%" stop-color="#65ca5d"/><stop offset="75%" stop-color="#6cce5a"/><stop offset="76%" stop-color="#71cf56"/><stop offset="77%" stop-color="#77d052"/><stop offset="78%" stop-color="#7dd14e"/><stop offset="79%" stop-color="#83d34a"/><stop offset="80%" stop-color="#89d447"/><stop offset="81%" stop-color="#8fd543"/><stop offset="82%" stop-color="#95d63f"/><stop offset="83%" stop-color="#9bd83b"/><stop offset="84%" stop-color="#a1d938"/><stop offset="85%" stop-color="#a7da34"/><stop offset="86%" stop-color="#addc30"/><stop offset="87%" stop-color="#b3dd2c"/><stop offset="88%" stop-color="#b8de2a"/><stop offset="89%" stop-color="#bedf2a"/><stop offset="90%" stop-color="#c4e029"/><stop offset="91%" stop-color="#cae029"/><stop offset="92%" stop-color="#cfe128"/><stop offset="93%" stop-color="#d5e228"/><stop offset="94%" stop-color="#dbe327"/><stop offset="95%" stop-color="#e1e427"/><stop offset="96%" stop-color="#e6e426"/><stop offset="97%" stop-color="#ece526"/><stop offset="98%" stop-color="#f2e625"/><stop offset="99%" stop-color="#f8e725"/></linearGradient></defs><rect id="gradientRect" width="20" height="95%" fill="url(#Gradient)"/><text x="25" y="12px" font-family="sans-serif" font-size="12px" text-anchor="start">4</text><text x="25" y="50%" font-family="sans-serif" font-size="12px" text-anchor="start">2</text><text x="25" y="95%" font-family="sans-serif" font-size="12px" text-anchor="start">0</text>']);
    });
    ...
    test('Test ColorViewController.getColorList works', function() {
      ...
      deepEqual(ColorViewController.getColorList(twenty, 'BrBG', false),
                [{'0': '#543005', '1': '#6e4a1c', '2': '#866231', '3': '#9c7a46', '4': '#b0905a', '5': '#c1a46e', '6': '#d1b681', '7': '#dec693', '8': '#e9d4a4', '9': '#f1dfb4', '10': '#f6e8c3', '11': '#f4e9cb', '12': '#efe9d1', '13': '#e6e6d3', '14': '#dae1d2', '15': '#c9dace', '16': '#b6d1c7', '17': '#9ec6bd', '18': '#82b8b1', '19': '#61a9a1'}, undefined]);

      deepEqual(ColorViewController.getColorList(one, 'OrRd', false), [{'0': '#fff7ec'}, undefined]);
      deepEqual(ColorViewController.getColorList(one, 'RdGy', true), [{'0': '#67001f'}, undefined]);
    ...
    test('Testing toJSON', function() {
      ...
      var exp = {category: 'SampleID', colormap: 'discrete-coloring-qiime',
                 continuous: false, data: {'PC.636': '#ff0000', 'PC.635': '#0000ff', 'PC.634': '#f27304'}};
      deepEqual(obs, exp);
    });
    ...
    test('Testing fromJSON', function() {
      ...
      equal(controller.decompViewDict.scatter.markers[idx + 2].material.color.getHexString(), '0000ff');
    ...
    test('Testing fromJSON scaled', function() {
      ...
      controller.fromJSON(json);
      var idx = 0;
      equal(controller.decompViewDict.scatter.markers[idx].material.color.getHexString(), '440154');
      equal(controller.decompViewDict.scatter.markers[idx + 1].material.color.getHexString(), 'ae1221');
      equal(controller.decompViewDict.scatter.markers[idx + 2].material.color.getHexString(), 'fee825');
